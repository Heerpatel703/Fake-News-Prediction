# -*- coding: utf-8 -*-
"""
Created on Tue Jul 23 21:53:58 2024
...
preprocess = pickle.load(open('D:/Fake News Prediction Deploy/vectorizer.sav', 'rb'))
loaded_model = pickle.load(open('D:/Fake News Prediction Deploy/trained_model.sav', 'rb'))
